...
from . import (click_size, ops_3de, ops_assist, ops_diag, ops_pin, ops_qc,
               ops_report, ops_seed, overlay, panel, prefs)

MODULES = (prefs, ops_3de, ops_seed, ops_assist, ops_diag, ops_pin, ops_qc,
           ops_report, panel)
